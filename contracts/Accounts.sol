...
contract Accounts is Data {
    ...
    /// @param amount Amount of tokens to deposit on Account. User should have
    ///     enough balance and issue an approve method prior to calling this.
    /// @param accountId The id of the user account -1 will register a new
    ///     account and deposit the requested amount on a single operation.
